...
var textImg,textImg1,textImg2,textImg3,textImg4,textImg5,textImg6,textImg7,textImg8,textImg9,textImg10,textImg11;
var hospitalImg;
...
var y;
var img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img13;
...
function preload(){
  ...
  boyImg = loadImage("Real-removebg-preview.png");
...
againT = createSprite(300,350);
againT.addImage(againImg);
againT.scale = 0.5;
againT.visible = false;
  
wall = createSprite(300,300);
wall.addImage(anotherImg);
wall.scale = 0.5;
wall.depth = game.depth-2;
wall.visible = false;
...
ci = createSprite(267,260);
ci.addImage(cImg);
ci.scale = 0.5;
ci.visible = false;
  
winA = createSprite(270,150);
...
img12 = createSprite(334,480);
img12.addImage(textImg10);
img12.scale = 0.089;
img12.visible = false;
  
img13 = createSprite(260,150);
img13.addImage(textImg11);
img13.scale = 0.089;
img13.visible = false;
...
boy1.collide(invisibleBar);
  ...
  if(gameState === "serve"){
    ...
    stroke("black");
    textSize(20);
    text("HI ! FRIENDS , I AM RAHUL. I AM LIVING IN BANGALORE",30,100);
...
function avoid(){
  if(frameCount%140===0){
    ...
    hurdle.scale = 0.2;
    hurdle.velocityX = -8;
    hurdle.setCollider("circle",0,0,160);
    hurdle.debug = false;
